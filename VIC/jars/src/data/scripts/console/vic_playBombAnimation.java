...
public class vic_playBombAnimation implements BaseCommand {
    ...
    public CommandResult runCommand(@NotNull String args, @NotNull BaseCommand.CommandContext context) {
        ...
        if (target != null) {
            Global.getLogger(vic_playBombAnimation.class).info(target.getId());
        ...
        Global.getLogger(vic_playBombAnimation.class).info("no target found");
        return null;
    }
    ...
    public static class ViralBombardmentAnimation implements EveryFrameScript {
        ...
        public ViralBombardmentAnimation(int num, SectorEntityToken target) {
            ...
            distancePercent = MathUtils.getRandomNumberInRange(0.30f, 0.70f);
            distance = distancePercent * target.getRadius();
        }
        ...
        public void advance(float amount) {
            ...
            Color color = new Color(255, 174, 0, 255);
