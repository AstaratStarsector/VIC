...
//		glowAngle2 = 0f;
        ...
        if (glowAsLayer) {
            ...
            SpriteAPI flare = Global.getSettings().getSprite("campaignEntities", "vic_archangel_flare2");
            Color flareColor = new Color(0, 255, 144, 255);
            flare.setSize(256f * (0.9f + 0.3f * (float) Math.random()) * 0.50f, 128f * (0.9f + 0.3f * (float) Math.random()) * 0.75f);
