...
public class vic_gatebreakerShotgunOnFireRight implements EveryFrameWeaponEffectPlugin, OnFireEffectPlugin {
    ...
    public void onFire(DamagingProjectileAPI projectile, WeaponAPI weapon, CombatEngineAPI engine) {
        ...
        if (projNumber < 19){
           ...
           DamagingProjectileAPI gatebreakerShrapnelRight = (DamagingProjectileAPI)Global.getCombatEngine().spawnProjectile(weapon.getShip(), null, "vic_gatebreaker_shotgun_shrapnel", muzzleLocation,
            ...
            DamagingProjectileAPI gatebreakerShrapnelRight2 = (DamagingProjectileAPI)Global.getCombatEngine().spawnProjectile(weapon.getShip(), null, "vic_gatebreaker_shotgun_shrapnel", muzzleLocation,
                    shrapnelDir2, weapon.getShip().getVelocity());
            gatebreakerShrapnelRight2.getVelocity().scale(MathUtils.getRandomNumberInRange(0.25f, 0.75f));
            DamagingProjectileAPI gatebreakerShrapnelRight3 = (DamagingProjectileAPI)Global.getCombatEngine().spawnProjectile(weapon.getShip(), null, "vic_gatebreaker_shotgun_shrapnel", muzzleLocation,
                    shrapnelDir3, weapon.getShip().getVelocity());
            gatebreakerShrapnelRight3.getVelocity().scale(MathUtils.getRandomNumberInRange(0.25f, 0.75f));
            DamagingProjectileAPI gatebreakerShrapnelRight4 = (DamagingProjectileAPI)Global.getCombatEngine().spawnProjectile(weapon.getShip(), null, "vic_gatebreaker_shotgun_shrapnel", muzzleLocation,
                    shrapnelDir4, weapon.getShip().getVelocity());
            gatebreakerShrapnelRight4.getVelocity().scale(MathUtils.getRandomNumberInRange(0.25f, 0.75f));
            DamagingProjectileAPI gatebreakerShrapnelRight5 = (DamagingProjectileAPI)Global.getCombatEngine().spawnProjectile(weapon.getShip(), null, "vic_gatebreaker_shotgun_shrapnel", muzzleLocation,
                    shrapnelDir5, weapon.getShip().getVelocity());
            gatebreakerShrapnelRight5.getVelocity().scale(MathUtils.getRandomNumberInRange(0.25f, 0.75f));
