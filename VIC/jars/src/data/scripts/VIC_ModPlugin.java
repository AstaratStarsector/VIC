...
import data.scripts.weapons.ai.vic_fieldDisruptor;
...
public class VIC_ModPlugin extends BaseModPlugin {
    ...
    public static final String FIELD_DISRUPTOR = "vic_fieldDisruptor_shot";

    @Override
    public PluginPick<MissileAIPlugin> pickMissileAI(MissileAPI missile, ShipAPI launchingShip) {
        switch (missile.getProjectileSpecId()) {
            case FIELD_DISRUPTOR:
                return new PluginPick<MissileAIPlugin>(new vic_fieldDisruptor(missile, launchingShip), CampaignPlugin.PickPriority.MOD_SPECIFIC);
            default:
        }
        return null;
    }
