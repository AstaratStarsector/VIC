...
public class VIC_LaidlawMassDriverMuzzleFlash implements EveryFrameWeaponEffectPlugin {
    ...
    */
    ...
    static {
        ...
        PARTICLE_SPAWN_POINT_TURRET.put("RING0", new Vector2f(0f, 20f));
        PARTICLE_SPAWN_POINT_TURRET.put("RING", new Vector2f(0f, 35f));
        PARTICLE_SPAWN_POINT_TURRET.put("RING2", new Vector2f(0f, 50f));
    }
    ...
    static {
        ...
        PARTICLE_SPAWN_POINT_HARDPOINT.put("RING0", new Vector2f(0f, 20f));
        PARTICLE_SPAWN_POINT_HARDPOINT.put("RING", new Vector2f(0f, 35f));
        PARTICLE_SPAWN_POINT_HARDPOINT.put("RING2", new Vector2f(0f, 50f));
    }
    ...
    static {
        ...
        PARTICLE_SIZE_MIN.put("FLASH_ID_5", 8f);
    ...
    static {
        ...
        PARTICLE_SIZE_MAX.put("FLASH_ID_5", 15f);
