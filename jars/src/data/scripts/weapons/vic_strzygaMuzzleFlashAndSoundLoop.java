...
public class vic_strzygaMuzzleFlashAndSoundLoop implements EveryFrameWeaponEffectPlugin, OnFireEffectPlugin {


    /* Don't change any of these unless you are hearing artifacts! */
    private static final float MIN_LOUDNESS = 0.05f;
    private static final float TIME_TO_FULL_LOUDNESS = 0.01f;
    ...
    private static final String START_SOUND = "vic_strzyga_start";
    private static final String LOOP_SOUND = "vic_strzyga_loop";
    private static final String END_SOUND = "vic_strzyga_end";
    ...
    static {
        ...
        PARTICLE_SPAWN_POINT_TURRET.put("BLOWBACK_ID_1", new Vector2f(25f, -35f));
        PARTICLE_SPAWN_POINT_TURRET.put("BLOWBACK_ID_2", new Vector2f(-25f, -35f));
    }
    ...
    static {
        ...
        PARTICLE_COLOR.put("BLOWBACK_ID_1", new Color(255, 255, 255, 125));
        PARTICLE_COLOR.put("BLOWBACK_ID_2", new Color(255, 255, 255, 125));
    ...
    static {
        ...
        PARTICLE_SIZE_MIN.put("FLASH_CORE_1", 45f);
    ...
    static {
        ...
        PARTICLE_SIZE_MAX.put("FLASH_CORE_1", 65f);
    ...
    static {
        ...
        PARTICLE_VELOCITY_MIN.put("BLOWBACK_ID_2", 70f);
    ...
    static {
        ...
        PARTICLE_DURATION_MIN.put("FLASH_CORE_1", 0.1f);
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        //Sound Loop Script by Mesotronik
        //Sound Loop Script by Mesotronik
        //Sound Loop Script by Mesotronik
    ...
    public void onFire(DamagingProjectileAPI projectile, WeaponAPI weapon, CombatEngineAPI engine) {
        ...
        Vector2f nebulaSpeed = (Vector2f) Misc.getUnitVectorAtDegreeAngle(trueArcFacing).scale(MathUtils.getRandomNumberInRange(5f, 15f));

        Global.getCombatEngine().addNebulaSmokeParticle(muzzleLocation, nebulaSpeed, 30f, 2f, 0.5f, 0.5f, 0.5f, new Color(MathUtils.getRandomNumberInRange(50,70), MathUtils.getRandomNumberInRange(35,45), MathUtils.getRandomNumberInRange(25,35), 255));
