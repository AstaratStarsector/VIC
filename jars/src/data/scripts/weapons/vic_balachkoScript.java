...
public class vic_balachkoScript implements EveryFrameWeaponEffectPlugin, OnFireEffectPlugin {
  ...
  */
    ...
    static {
        ...
        ON_SHOT_PARTICLE_COUNT.put("FLASH_ID_1", 15);
        ON_SHOT_PARTICLE_COUNT.put("FLASH_ID_2", 15);
        ON_SHOT_PARTICLE_COUNT.put("BLOWBACK_ID_1", 5);
        ON_SHOT_PARTICLE_COUNT.put("BLOWBACK_ID_2", 5);
        ON_SHOT_PARTICLE_COUNT.put("BLOWBACK_ID_3", 5);
    ...
    static {
        ...
        PARTICLES_PER_SECOND.put("BLOWBACK_ID_2", 10f);
        PARTICLES_PER_SECOND.put("BLOWBACK_ID_3", 10f);
    }
    ...
    static {
        ...
        PARTICLE_SIZE_MIN.put("BLOWBACK_ID_2", 3f);
        PARTICLE_SIZE_MIN.put("BLOWBACK_ID_3", 3f);
    ...
    static {
        ...
        PARTICLE_SIZE_MAX.put("BLOWBACK_ID_2", 5f);
        PARTICLE_SIZE_MAX.put("BLOWBACK_ID_3", 5f);
    }
    ...
    static {
        ...
        PARTICLE_VELOCITY_MIN.put("BLOWBACK_ID_2", 30f);
        PARTICLE_VELOCITY_MIN.put("BLOWBACK_ID_3", 30f);
    ...
    static {
        ...
        PARTICLE_VELOCITY_MAX.put("BLOWBACK_ID_2", 50f);
        PARTICLE_VELOCITY_MAX.put("BLOWBACK_ID_3", 50f);
    ...
    static {
        PARTICLE_DURATION_MIN.put("default", 0.25f);
        PARTICLE_DURATION_MIN.put("BLOWBACK_ID_1", 0.75f);
        PARTICLE_DURATION_MIN.put("BLOWBACK_ID_2", 0.20f);
        PARTICLE_DURATION_MIN.put("BLOWBACK_ID_3", 0.20f);
    ...
    static {
        PARTICLE_DURATION_MAX.put("default", 0.75f);
        PARTICLE_DURATION_MAX.put("BLOWBACK_ID_1", 1.5f);
        PARTICLE_DURATION_MAX.put("BLOWBACK_ID_2", 0.40f);
        PARTICLE_DURATION_MAX.put("BLOWBACK_ID_3", 0.40f);
    ...
    static {
        ...
        PARTICLE_ARC_FACING.put("BLOWBACK_ID_2", 90f);
        PARTICLE_ARC_FACING.put("BLOWBACK_ID_3", -90f);
