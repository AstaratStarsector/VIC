...
public class vic_gaganaUltraOnFire implements EveryFrameWeaponEffectPlugin, OnFireEffectPlugin {
    ...
    static {
        ...
        PARTICLES_PER_SECOND.put("BLOWBACK_ID_1", 20f);
    ...
    static {
        ...
        PARTICLE_COLOR.put("READY_STEAM_ID_1", new Color(255, 255, 255, 50));
    ...
    static {
        ...
        PARTICLE_SIZE_MIN.put("BLOWBACK_ID_1", 5f);
        PARTICLE_SIZE_MIN.put("READY_STEAM_ID_1", 5f);
    ...
    static {
        ...
        PARTICLE_SIZE_MAX.put("BLOWBACK_ID_1", 10f);
        PARTICLE_SIZE_MAX.put("READY_STEAM_ID_1", 10f);
    ...
    static {
        ...
        PARTICLE_VELOCITY_MAX.put("BLOWBACK_ID_1", 25f);
    ...
    public void onFire(DamagingProjectileAPI projectile, WeaponAPI weapon, CombatEngineAPI engine) {
        ...
        Vector2f nebulaSideSpeed3 = (Vector2f) Misc.getUnitVectorAtDegreeAngle(weapon.getCurrAngle() + MathUtils.getRandomNumberInRange(-360f, 360f)).scale(MathUtils.getRandomNumberInRange(0f, 15f));
        Vector2f nebulaSideSpeed4 = (Vector2f) Misc.getUnitVectorAtDegreeAngle(weapon.getCurrAngle() + MathUtils.getRandomNumberInRange(-360f, 360f)).scale(MathUtils.getRandomNumberInRange(0f, 15f));
        Vector2f nebulaSideSpeed5 = (Vector2f) Misc.getUnitVectorAtDegreeAngle(weapon.getCurrAngle() + MathUtils.getRandomNumberInRange(-360f, 360f)).scale(MathUtils.getRandomNumberInRange(0f, 15f));

        Global.getCombatEngine().addNebulaParticle(muzzleLocation, nebulaSideSpeed1, MathUtils.getRandomNumberInRange(10f, 25f), MathUtils.getRandomNumberInRange(3f, 5f), 0.2f, 0.2f, MathUtils.getRandomNumberInRange(1.5f, 3f), new Color(62, 46, 29, 50));
        Global.getCombatEngine().addNebulaParticle(muzzleLocation, nebulaSideSpeed2, MathUtils.getRandomNumberInRange(10f, 25f), MathUtils.getRandomNumberInRange(3f, 5f), 0.2f, 0.2f, MathUtils.getRandomNumberInRange(1.5f, 3f), new Color(50, 50, 50, 150));
        Global.getCombatEngine().addNebulaParticle(muzzleLocation, nebulaSideSpeed3, MathUtils.getRandomNumberInRange(10f, 25f), MathUtils.getRandomNumberInRange(3f, 5f), 0.2f, 0.2f, MathUtils.getRandomNumberInRange(1.5f, 3f), new Color(144, 102, 58, 50));
        Global.getCombatEngine().addNebulaParticle(muzzleLocation, nebulaSideSpeed4, MathUtils.getRandomNumberInRange(10f, 25f), MathUtils.getRandomNumberInRange(3f, 5f), 0.2f, 0.2f, MathUtils.getRandomNumberInRange(1.5f, 3f), new Color(50, 50, 50, 150));
        Global.getCombatEngine().addNebulaParticle(muzzleLocation, nebulaSideSpeed5, MathUtils.getRandomNumberInRange(10f, 25f), MathUtils.getRandomNumberInRange(3f, 5f), 0.2f, 0.2f, MathUtils.getRandomNumberInRange(1.5f, 3f), new Color(62, 46, 29, 50));
        Global.getCombatEngine().addNebulaParticle(muzzleLocation, nebulaSideSpeed1, MathUtils.getRandomNumberInRange(10f, 25f), MathUtils.getRandomNumberInRange(3f, 5f), 0.2f, 0.2f, MathUtils.getRandomNumberInRange(1.5f, 3f), new Color(50, 50, 50, 150));
        Global.getCombatEngine().addNebulaParticle(muzzleLocation, nebulaSideSpeed2, MathUtils.getRandomNumberInRange(10f, 25f), MathUtils.getRandomNumberInRange(3f, 5f), 0.2f, 0.2f, MathUtils.getRandomNumberInRange(1.5f, 3f), new Color(38, 22, 14, 50));
        Global.getCombatEngine().addNebulaParticle(muzzleLocation, nebulaSideSpeed3, MathUtils.getRandomNumberInRange(10f, 25f), MathUtils.getRandomNumberInRange(3f, 5f), 0.2f, 0.2f, MathUtils.getRandomNumberInRange(1.5f, 3f), new Color(50, 50, 50, 150));
        Global.getCombatEngine().addNebulaParticle(muzzleLocation, nebulaSideSpeed4, MathUtils.getRandomNumberInRange(10f, 25f), MathUtils.getRandomNumberInRange(3f, 5f), 0.2f, 0.2f, MathUtils.getRandomNumberInRange(1.5f, 3f), new Color(83, 47, 13, 50));
        Global.getCombatEngine().addNebulaParticle(muzzleLocation, nebulaSideSpeed5, MathUtils.getRandomNumberInRange(10f, 25f), MathUtils.getRandomNumberInRange(3f, 5f), 0.2f, 0.2f, MathUtils.getRandomNumberInRange(1.5f, 3f), new Color(50, 50, 50, 150));
