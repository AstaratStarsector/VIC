...
public class vic_gaganaScript implements EveryFrameWeaponEffectPlugin {
    ...
    static {
        ...
        PARTICLE_SPAWN_POINT_TURRET.put("BLOWBACK_ID_1", new Vector2f(0f, -35f));
        PARTICLE_SPAWN_POINT_TURRET.put("BLOWBACK_ID_2", new Vector2f(0f, -37.5f));
        PARTICLE_SPAWN_POINT_TURRET.put("BLOWBACK_ID_3", new Vector2f(0f, -37.5f));
    ...
    static {
        ...
        PARTICLE_SPAWN_POINT_HARDPOINT.put("BLOWBACK_ID_1", new Vector2f(0f, -32.5f));
        PARTICLE_SPAWN_POINT_HARDPOINT.put("BLOWBACK_ID_2", new Vector2f(0f, -35f));
        PARTICLE_SPAWN_POINT_HARDPOINT.put("BLOWBACK_ID_3", new Vector2f(0f, -35f));
    ...
    static {
        ...
        PARTICLE_COLOR.put("SMOKE_3", new Color(150,140,140, 35));
        ...
        PARTICLE_COLOR.put("BLOWBACK_ID_2", new Color(255, 175, 65));
